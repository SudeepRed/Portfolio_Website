  ...
  _decodeLight(e) {
    if ("hemispheric" === e.type) {
      ...
      const t = new THREE.Color().fromArray(
        ...
        a = void 0 !== e.decay ? e.decay : 1,
        s =
          void 0 !== e.spot.innerConeAngle
            ? e.spot.innerConeAngle
            : Math.PI / 3,
...
(THREE.OrbitControls = function (e, t) {
  ...
  void 0 === t &&
    ...
    (this.dispose = function () {
      h.domElement.removeEventListener("contextmenu", ee, !1),
        ...
        h.domElement.removeEventListener("wheel", X, !1),
        ...
        h.domElement.ownerDocument.removeEventListener("pointerup", J, !1),
      ...
      return function (t, i) {
        ...
        if (h.object.isPerspectiveCamera) {
          ...
          (s *= Math.tan(((h.object.fov / 2) * Math.PI) / 180)),
            O((2 * t * s) / r.clientHeight, h.object.matrix),
            C((2 * i * s) / r.clientHeight, h.object.matrix);
        } else
  ...
  function F(e) {
    ...
    R.subVectors(T, b).multiplyScalar(h.panSpeed), D(R.x, R.y), b.copy(T);
  }
  function Y(e) {
    var t = e.touches[0].pageX - e.touches[1].pageX,
      i = e.touches[0].pageY - e.touches[1].pageY,
      r = Math.sqrt(t * t + i * i);
    M.set(0, r), L.set(0, Math.pow(M.y / w.y, h.zoomSpeed)), B(L.y), w.copy(M);
  }
  function W(e) {
    if (!1 !== h.enabled)
        ...
        case "pen":
          !(function (e) {
            ...
            u !== m.NONE &&
              ...
              h.domElement.ownerDocument.addEventListener("pointerup", J, !1),
              h.dispatchEvent(c));
          })(e);
      }
  }
  ...
  function X(e) {
    !1 === h.enabled ||
      ...
      h.dispatchEvent(c),
      (function (e) {
        e.deltaY < 0 ? U(I()) : e.deltaY > 0 && B(I()), h.update();
      })(e),
      h.dispatchEvent(d));
  }
  function q(e) {
    !1 !== h.enabled &&
      ...
      (function (e) {
        ...
        switch (e.keyCode) {
          case h.keys.UP:
            D(0, h.keyPanSpeed), (t = !0);
            break;
          case h.keys.BOTTOM:
            D(0, -h.keyPanSpeed), (t = !0);
            break;
          case h.keys.LEFT:
            D(h.keyPanSpeed, 0), (t = !0);
            break;
          case h.keys.RIGHT:
            D(-h.keyPanSpeed, 0), (t = !0);
        }
        ...
        case 2:
          switch (h.touches.TWO) {
            ...
            case THREE.TOUCH.DOLLY_ROTATE:
              ...
              !(function (e) {
                h.enableZoom && V(e), h.enableRotate && G(e);
              })(e),
  ...
  h.domElement.addEventListener("contextmenu", ee, !1),
    ...
    h.domElement.addEventListener("wheel", X, !1),
  ...
  (Interaction.prototype = {
    ...
    play: function (e) {
      !0 === this.object.visible &&
        void 0 !== e.state &&
        this.animate(e.state, e);
    },
    reverse: function (e) {
      !0 === this.object.visible && this.animate(this.prevState, e);
    },
  ...
  (SPE.ConeGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (d.toJSON = SPE.Geometry.Utils.toJSON.bind(d)),
        d
      );
    }),
  ...
  (SPE.CubeGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (h.toJSON = SPE.Geometry.Utils.toJSON.bind(h)),
        h
      );
    }),
      (this.buildFromGeometry = function (
...
SPE.CylinderGeometry = new (function () {
  (this.build = function ({
    ...
    return (
      ...
      (p.toJSON = SPE.Geometry.Utils.toJSON.bind(p)),
      p
    );
  }),
    (this.buildFromGeometry = function (
...
class RoundedCylinderBufferGeometry extends THREE.BufferGeometry {
  constructor(e, t, i, r, a, s, n, o, h, l, c, d, m = !1) {
    ...
    let T = new u(e, S),
      ...
      A = 0,
      O = 0;
    d > 0 && ((H = Math.min(e, t) * (1 - d)), (A = e - H), (O = t - H));
    const C = T.clone();
    C.x -= H;
    const D = Math.PI - P.angle(),
      B = P.angle(),
      U = Math.tan(B / 2),
      $ = Math.tan(D / 2),
      N = U + $,
      ...
      z = d ? N : U;
    if (
      ((h = Math.min(h, (e - A) / G, P.length() / N)),
      (l = Math.min(l, (t - O) / z, P.length() / N)),
      h > 0)
    ) {
      const e = h / U;
    ...
    if (l > 0) {
      ...
      (M = R.clone().sub(new u(e, -l))),
        ...
        d && (((I = M.clone()).x -= H - N * l), C.sub(P.clone().setLength(e)));
    }
    ...
    for (let c = 0; c <= r; c++) {
      ...
      I
        ? (F(m, p, E, D, l, I, -1, !0), F(m, p, E, B, l, M, -1, !1))
        : M
        ? (Y(m, E, M.x, 0, -1), F(m, p, E, B, l, M, -1, !1))
        : s || Y(m, E, t, O, -1);
      ...
      if (
        (L
          ? (F(m, p, E, D, h, w, 1, !1), F(m, p, E, B, h, L, 1, !0))
          : w
          ? (F(m, p, E, D, h, w, 1, !1), Y(m, E, w.x, 0, 1))
          : s || Y(m, E, e, A, 1),
        d && !V)
      ) {
        ...
        for (let e = 0; e <= a; e++) {
          const t = e / a,
            r = P.clone().multiplyScalar(-t).add(C);
          two2three(r, E, b),
            g.push(b.x, b.y, b.z),
            y.push(x.x, x.y, x.z),
            v.push(p, 0.5 + b.y / i),
  ...
  (SPE.EllipseGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (s.toJSON = SPE.Geometry.Utils.toJSON.bind(s)),
        s
      );
    }),
      (this.buildFromGeometry = function (
  ...
  (SPE.IcosahedronGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (a.toJSON = SPE.Geometry.Utils.toJSON.bind(a)),
        a
      );
    }),
      (this.buildFromGeometry = function (
  ...
  (SPE.PolygonGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (o.toJSON = SPE.Geometry.Utils.toJSON.bind(o)),
        o
      );
    }),
      (this.buildFromGeometry = function (
...
function genHelix(e, t, i, r, a, s, n, o, h, l, c, d) {
  ...
  for (let t = 0; t <= j; t++) {
    q(M, t),
      ...
      D.copy(M)
        .setComponent(e + 1, 0)
        .normalize(),
      B.crossVectors(U, D).normalize();
    const i = 0 == t ? (3 * Math.PI) / 2 : k,
      r = 0 == t ? 0 : Q;
    for (let e = 0, a = 0; e <= l; a = ++e * W) {
      if (
        (A.addVectors(
          I.copy(D).multiplyScalar(o * Math.cos(a)),
          P.copy(B).multiplyScalar(o * Math.sin(a))
        ),
        C.copy(A).normalize(),
        0 == t || t == j)
      ) {
        P.copy(C).multiplyScalar(J), L.addVectors(M, P);
        for (let a = 0, s = i; a < d; s = ++a * k + i) {
          O.addVectors(
            I.copy(U).multiplyScalar(X * Math.sin(s)),
            P.copy(C).multiplyScalar(X * Math.cos(s))
          ),
            P.addVectors(L, O),
            O.normalize(),
            E.push(P.x, P.y, P.z),
  ...
  return (
    ...
    (ie.toJSON = SPE.Geometry.Utils.toJSON.bind(ie)),
    ie
  );
}
(SPE.RectangleGeometry = new (function () {
  (this.build = function ({
    ...
    return (
      ...
      (u.toJSON = SPE.Geometry.Utils.toJSON.bind(u)),
      u
    );
  }),
    (this.buildFromGeometry = function (
  ...
  (SPE.SphereGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (l.toJSON = SPE.Geometry.Utils.toJSON.bind(l)),
        l
      );
    }),
      (this.buildFromGeometry = function (
  ...
  (SPE.TorusGeometry = new (function () {
    (this.build = function ({
      ...
      return (
        ...
        (c.toJSON = SPE.Geometry.Utils.toJSON.bind(c)),
        c
      );
    }),
      (this.buildFromGeometry = function (
  ...
  (SPE.TextFrameGeometry = new (function () {
    (this.build = function ({ width: e = 100, height: t = e }) {
      ...
      return (
        ...
        (i.toJSON = SPE.Geometry.Utils.toJSON.bind(i)),
        i
      );
    }),
      (this.buildFromGeometry = function (
  ...
  (SPE.Geometry.Utils = new (function () {
    (this.toJSON = function () {
      const e = { uuid: this.uuid };
      return (
        Object.keys(this.userData).length > 0 && (e.userData = this.userData), e
      );
    }),
...
(SPE.CombinedCamera = class extends THREE.Camera {
  constructor(e = 100, t = 100, i = 45, r = 50, a = 5e4) {
    super(),
      (e = window.innerWidth),
  ...
  (SPE.Box3.prototype.computeEdges = function () {
    this.vertices || this.computeVertices(),
      ...
      (this.centerEdges = this.edges.map((e) =>
        e.getCenter(new THREE.Vector3())
      ));
  }),
